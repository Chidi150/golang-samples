...
func init() {
	...
	//
	DB, err = configureDatastoreDB("idumotalag")
	// [END datastore]
	...
	// production.
	//
	OAuthConfig = configureOAuthClient("308603119264-493rrffrsshdq8dq0me50dnkh7fu2d7r.apps.googleusercontent.com", "80H0eUOgm6oGBGpbNmw1ASuY")
	// [END auth]
	...
	cookieStore := sessions.NewCookieStore([]byte("Very!234-Secret!234-Pa55w0rd!234"))
